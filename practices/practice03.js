...
//Tricky part- discuss in the interview
console.log(tripleWord(""));
console.log(tripleWord(1)); 
console.log(tripleWord("1")); 
...
console.log(celciusToFahrenheit("Ten")); //NaN
