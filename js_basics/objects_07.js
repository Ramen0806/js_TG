...
for(const product of appleStore) {
    ...
    AllProductsNames.push(product.productName);
    if(product.price > most_expensive.price) most_expensive = product;
    if(product.quantity > highest_quantity.quantity) highest_quantity = product;
    if(product.price < least_expensive.price) least_expensive = product;
    if(product.quantity < least_quantity.quantity) least_quantity = product;

}

console.log(most_expensive.productName);
console.log(highest_quantity.productName);

console.log(least_expensive.productName);
console.log(least_quantity.productName);
