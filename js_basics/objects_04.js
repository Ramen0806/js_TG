...
// Count how many names start with A or I -> 4
// count how many users has email with gmail ->
...
for (const user of users) {
    ...
    if (user.email.endsWith("gmail.com"))countGmail ++;
    if (parseInt(user.dob.split('-')[1]) <= 3)  countMdob++;
}

console.log(count); //4
console.log(countGmail); //9
console.log(countMdob); //3 
